...
public class NativeAdvance640X320Activity extends Activity implements INativeAdvanceLoadListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_native_advance_text_img_640_320);
    ...
    public void showAd() {
        ...
        if (null != mINativeAdData && mINativeAdData.isAdValid()) {
            ...
            mINativeAdData.setInteractListener(new INativeAdvanceInteractListener() {
                ...
                @Override
                public void onClick() {
                    Toast.makeText(NativeAdvance640X320Activity.this, "原生广告点击", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onShow() {
                    Toast.makeText(NativeAdvance640X320Activity.this, "原生广告展示", Toast.LENGTH_SHORT).show();
                }

                @Override
                public void onError(int code, String msg) {
                    Toast.makeText(NativeAdvance640X320Activity.this, "原生广告出错，ret:" + code + ",msg:" + msg, Toast.LENGTH_SHORT).show();
                }
            });
            /**
    ...
    private void initData() {
         ...
         *构造NativeAd对象。
         */
        mNativeAdvanceAd = new NativeAdvanceAd(this, Constants.NATIVE_ADVANCE_640X320_TEXT_IMG_POS_ID, this);
    }
