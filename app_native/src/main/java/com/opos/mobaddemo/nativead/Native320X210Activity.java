...
public class Native320X210Activity extends Activity implements INativeAdListener {
    ...
    private void initData() {
         ...
         *构造NativeAd对象。
         */
        mNativeAd = new NativeAd(this, Constants.NATIVE_320X210_TEXT_IMG_POS_ID, this);
    }
    ...
    public void onAdSuccess(List iNativeAdDataList) {
        if (null != iNativeAdDataList && iNativeAdDataList.size() > 0) {
            ...
            Toast.makeText(Native320X210Activity.this, "加载原生广告成功", Toast.LENGTH_SHORT).show();
        }
    }

    @Override
    public void onAdFailed(NativeAdError nativeAdError) {
        Toast.makeText(Native320X210Activity.this, "加载原生广告失败,错误码：" + nativeAdError.toString(), Toast.LENGTH_LONG).show();
    }

    @Override
    public void onAdError(NativeAdError nativeAdError, INativeAdData iNativeAdData) {
        Toast.makeText(Native320X210Activity.this, "调用原生广告统计方法出错,错误码：" + nativeAdError.toString(), Toast.LENGTH_LONG).show();
    }
}
